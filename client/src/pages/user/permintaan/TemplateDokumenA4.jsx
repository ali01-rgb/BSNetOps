      ...
      <table className="w-full border-collapse border-2 border-black text-sm mb-6">
        <thead>
          <tr className="bg-gray-100 font-bold">
            <th className="border-2 border-black w-[5%] py-2">No</th>
            <th className="border-2 border-black w-[35%] py-2">Nama Barang</th>
            <th className="border-2 border-black w-[15%] py-2">Prioritas</th>
            <th className="border-2 border-black w-[10%] py-2">Jumlah</th>
            <th className="border-2 border-black w-[35%] py-2">Keterangan</th>
          </tr>
        </thead>
        <tbody>
          {rows.map((_, index) => {
            ...
            return (
              <tr key={index} className="h-[40px]">
                ...
                {/* 🔥 PERBAIKAN: Kolom Prioritas ditambahkan ke PDF */}
                <td className="border-2 border-black text-center text-xs font-semibold">

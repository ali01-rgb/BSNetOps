  ...
  return (
    ...
    >
      <div>
        ...
        <p className="text-xs text-white/80 mt-0.5 font-medium">Kelola identitas personal dan unit penempatan Anda</p>
      </div>
        ...
        <form onSubmit={handleSave} className="p-6 pt-0 space-y-6 relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative flex items-center">
                <Layers size={16} className="absolute left-3 text-zinc-400" />
                <select
                  name="unit"
                  value={profile.unit}
                  onChange={handleChange}
          ...
          <div className="pt-6 border-t border-zinc-100 flex justify-end mt-4">
            <button
              type="submit"
              disabled={isLoading}
              className="px-5 py-2.5 bg-[#58a27d] hover:bg-[#478767] text-white rounded-lg text-sm font-bold flex items-center gap-2 shadow-md shadow-[#58a27d]/10 hover:shadow-lg transition-all cursor-pointer disabled:opacity-50"
            >

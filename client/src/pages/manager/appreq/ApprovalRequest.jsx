  ...
  return (
    <div className="w-full relative animate-in fade-in slide-in-from-bottom-4 duration-500 text-zinc-800">
      ...
      <div className="space-y-5">
        ...
        {/* Tabel Request Utama dengan Grid Width yang Proporsional */}
            ...
            <table className="w-full text-left border-collapse table-fixed">
              <thead>
                <tr className="border-b border-zinc-100 text-[11px] font-bold text-white uppercase bg-[#58a27d]">
                  ...
                  <th className="py-3 px-3 w-[14%]">ID Permintaan</th>
                  <th className="py-3 px-4 w-[18%]">Pemohon</th>
                  <th className="py-3 px-4 w-[25%]">Daftar Barang</th>
                  <th className="py-3 px-3 w-[12%] text-center">Prioritas</th>
                  ...
                  paginatedRequests.map((item) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-3 text-center">
                        <span className={`inline-flex items-center justify-center min-w-[65px] px-2 py-0.5 rounded-md text-[10px] font-black border ${
                      ...
                      <td className="py-4 px-4 text-center">
                        <span className={`inline-block px-3 py-1 rounded-md text-[11px] font-bold border capitalize whitespace-nowrap ${
